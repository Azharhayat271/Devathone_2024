        ...
        <div className="card h-100 p-0 radius-12">
          <div className="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3">
            ...
            >
              ...
              <MenuItem onClick={() => handleStatusFilterChange("approved")}>
                Approved
              </MenuItem>
              <MenuItem onClick={() => handleStatusFilterChange("created")}>
                Created
              </MenuItem>
            </Menu>
          </div>
          <div className="card-body p-24">
                  ...
                  {filteredUsers.map((user, index) => (
                    <tr key={user._id}>
                        ...
                        <div className="d-flex align-items-center">
                          <img
                            src={
                              user.image
                                ? user.image
                                : getDefaultImage(user.name, user.email)
                            }
                            alt={user.name}
                      ...
                      <td className="text-center">
                        <span
                          className={`text-md mb-0 fw-normal ${
                            user.status === "active"
                              ? "text-success-600"
                              : "text-neutral-600"
                          }`}
            ...
            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 mt-4">
              <div className="text-secondary-dark fw-semibold">
